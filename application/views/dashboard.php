...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url('<?php echo base_url()?>assets/images/big_image_2.jpg');">
      <div class="container">
    ...
    <div class="container site-section element-animate">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url('<?php echo base_url()?>assets/images/person_3.jpg');">
                <div class="box">
                  <h2>Job Smith</h2>
                  <p>Laravel Expert</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="<?php echo base_url()?>assets/images/person_3.jpg" alt="">
                  </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="block-2 ">
            <div class="flipper">
              <div class="front" style="background-image: url('<?php echo base_url()?>assets/images/person_1.jpg');">
                <div class="box">
                  <h2>Mellissa Cruz</h2>
                  <p>JavaScript Guru</p>
                </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url('<?php echo base_url()?>assets/images/person_2.jpg');">
                <div class="box">
                  <h2>Aldin Powell</h2>
                  <p>WordPress Ninja</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="<?php echo base_url()?>assets/images/person_2.jpg" alt="">
                  </div>
      ...
      <div class="container">
        ...
        <div class="row element-animate">
          ...
          <div class="col-md-12 mb-5 mb-lg-0 col-lg-6">
            ...
            <div class="block-20 ">
              <figure>
                <a href="#"><img src="<?php echo base_url()?>assets/images/img_1.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
          ...
          <div class="col-md-12 col-lg-6">
            ...
            <div class="block-21 d-flex mb-4">
              <figure class="mr-3">
                <a href="#"><img src="<?php echo base_url()?>assets/images/img_2.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
            ...
            <div class="block-21 d-flex mb-4">
              <figure class="mr-3">
                <a href="#"><img src="<?php echo base_url()?>assets/images/img_3.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
