    ...
    <div class="container">
      <div class="row m-auto">
        <div class="col-6">
          ...
          <img src="http://localhost/Soerabaja451/assets/images/z2.jpeg" alt="..." class="img-thumbnail">
        </div>
        <!--Rightside tampilan-->
        <div class="col-6">
          <div class="card card-custom bg-white border-white border-0">
            <div class="card-body">
             <img src="http://localhost/Soerabaja451/assets/images/z3.jpeg" alt="..." class="img-thumbnail">
           </div>
         </div>
       </div>
     </div>
