  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand absolute" href="dashboard">SOERABAJA'45</a>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url('<?php echo base_url()?>assets/images/imgnew.jpg');">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-8 order-md-2">
            <div class="row">
              <div class="col-md-12 col-lg-6 mb-5">
                <div class="block-19">
                  <figure>
                    <a href="<?php echo base_url()?>assets/course-single.html"><img src="<?php echo base_url()?>assets/images/imgvideo.jpg" alt="Image" class="img-fluid"></a>
                  </figure>
                    <div class="text">
                      <h2 class="heading"><a href="<?php echo base_url()?>assets/#">Advanced JavaScript Learning</a></h2>
              ...
              <div class="col-md-12 col-lg-6 mb-5">
                  ...
                  <div class="block-19">
                    <figure>
                      <a href="<?php echo base_url()?>assets/course-single.html"><img src="<?php echo base_url()?>assets/images/imgvideo1.jpg" alt="Image" class="img-fluid"></a>
                    </figure>
                    <div class="text">
                      <h2 class="heading"><a href="<?php echo base_url()?>assets/#">Introduction to CSS</a></h2>
                      <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
                      <div class="meta d-flex align-items-center">
                        <div class="number">
              ...
              <div class="col-md-12 col-lg-6 mb-5">
                <div class="block-19">
                  <figure>
                    <a href="<?php echo base_url()?>assets/course-single.html"><img src="<?php echo base_url()?>assets/images/imgvideo2.jpg" alt="Image" class="img-fluid"></a>
                  </figure>
                  <div class="text">
                    <h2 class="heading"><a href="<?php echo base_url()?>assets/#">Design &amp; Develop</a></h2>
                    <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
                    <div class="meta d-flex align-items-center">
                      <div class="number">
                        <span>23/100</span>
          ...
          <div class="col-md-6 col-lg-4 order-md-1">
            ...
            <div class="block-24 mb-5">
              <h3 class="heading">Kategori Produk Digital Offset</h3>
              <ul>
                <li><a href="<?php echo base_url()?>assets/#">Laravel <span>10</span></a></li>
                <li><a href="<?php echo base_url()?>assets/#">PHP <span>43</span></a></li>
                <li><a href="<?php echo base_url()?>assets/#">JavaScript <span>21</span></a></li>
                <li><a href="<?php echo base_url()?>assets/#">Python <span>65</span></a></li>
                <li><a href="<?php echo base_url()?>assets/#">iOS <span>34</span></a></li>
                <li><a href="<?php echo base_url()?>assets/#">Android <span>45</span></a></li>
                <li><a href="<?php echo base_url()?>assets/#">Swift <span>22</span></a></li>
              </ul>
            </div>
                ...
                <li>
                  <a href="<?php echo base_url()?>assets/#" class="d-flex">
                    <figure class="image mr-3">
                      <img src="<?php echo base_url()?>assets/images/imgvideo1_b.jpg" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
            ...
            <div class="block-26">
              ...
              <ul>
                <li><a href="<?php echo base_url()?>assets/#">code</a></li>
                <li><a href="<?php echo base_url()?>assets/#">design</a></li>
                <li><a href="<?php echo base_url()?>assets/#">typography</a></li>
                <li><a href="<?php echo base_url()?>assets/#">development</a></li>
                <li><a href="<?php echo base_url()?>assets/#">creative</a></li>
                <li><a href="<?php echo base_url()?>assets/#">codehack</a></li>
              </ul>
            </div>
