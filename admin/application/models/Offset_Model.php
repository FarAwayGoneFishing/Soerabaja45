...
class Offset_Model extends CI_Model{
	...
	public function data(){
		$query = $this->db->query("SELECT DISTINCT produk, tb_produk.id_master FROM produk JOIN tb_produk JOIN tb_harga WHERE tb_harga.jenis_produk = 'Offset' AND produk.id_master = tb_produk.id_master AND tb_produk.id_produk = tb_harga.id_produk");
		return $query->result();	
	}
