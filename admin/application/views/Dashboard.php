                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								...
								<li>
                                    <a href="index2.html">Digital Offset</a>
                                </li>
                                <li>
                                    <a href="index3.html">Offset</a>
                                </li>
                                <li>
                                    <a href="index4.html">Riwayat Transaksi</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="chart.html">
                                <i class="fas fa-chart-bar"></i>Produk Digital Offset</a>
                        </li>
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>Produk Offset</a>
                        </li>
                        <li>
                            <a href="form.html">
