...
<!--												<td id="id_pesan" style="display : none"><?php echo $row->id_pesan ?></td>-->
												...
												<?php if($row->status_bayar == "belum"){ ?>
													<td class="text-right"><a class="btn btn-danger" href="<?php echo base_url()?>Dashboard/bayar/<?php echo $row->id_pesan ?>" role="button">Bayar</a></td>
												<?php }else{ ?>
...
//			if(document.getElementsByClassName("input-sm").value != null || document.getElementsByClassName("input-sm").value != ""){
//				clearInterval(myvar);
//			}else{
//				myvar;
//			}
